...
| Note                                                                                                                                            | What it holds                                                                                                                                                                              |
| ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Source trace 2026-08-28](notes/traces/Source%20trace%202026-08-28.md)                                                                          | **Watermark for the next `requirements-check` run** — 2026-08-28T22:00Z · no client traffic; a five-week-old red flag re-posted verbatim, and an org check that corrected five `MAP.md` claims |
