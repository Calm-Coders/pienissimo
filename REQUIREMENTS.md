...
| INT-11 | **WooCommerce**               | Integration over **API**, not a plugin. Two instances to map: events/stage sales and books/marketing. 🔴 _Consumer Key and Secret owed by Sabatino._                                                                                                                                                                                     |  M   |   🔴   |
...
| INT-13 | WooCommerce                   | Development needed — Salesforce side: `WooCommerce_Product_Id__c` on Product, `WooCommerce_Order_Id__c` on Opportunity, a link-generator button with product and quantity pickers, order-reading logic. Pienissimo side: install the PHP snippet as a _must-use plugin_, generate REST credentials, build the pre-filled email template. |  M   |   ✅   |
| INT-14 | WooCommerce                   | **Integration direction**: scheduled pull job from Salesforce, or webhook from WooCommerce. 🔴 _ROMI recommends the webhook in production._                                                                                                                                                                                              |  M   |   🔴   |
...
|  9  | **WooCommerce Consumer Key and Secret** for both instances                                            | INT-11 | Sabatino              |
...
| :-: | -------------------------------------------------- | ------ | ------------------------------------------------ |
| 15  | WooCommerce integration direction                  | INT-14 | Webhook                                          |
