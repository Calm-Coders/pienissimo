...
⚠ **The two sessions do not close on the same object.** The morning agreed a _line_
identifier; the afternoon settled an _order_ identifier. Mexal's invoice references the
