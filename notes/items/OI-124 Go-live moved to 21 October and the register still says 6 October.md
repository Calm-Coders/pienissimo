...
# OI-124 - Go-live moved to 21 October and the register still says 6 October
...
**21 September** with approval by **13 September** — a date *earlier* than the
register, described as a *slittamento* that adds development weeks. That note
...
(entro 23/09)"** and **"Approvazione Soluzione 1 (entro 13/10)"**. A *slittamento*
